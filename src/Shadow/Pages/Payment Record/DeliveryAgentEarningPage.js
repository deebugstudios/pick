...
const fetchEarning = async() => {
 try {
    const res = await fetch("https://guarded-falls-60982.herokuapp.com/delivery_agent_earnings/view_single_delivery_agent_earnings", {
        method: "POST",
        headers: {
  ...
  return (
    ...
    <MainTop riderdata={riderdata}/>
      ...
      <div className="profile-page-bottom height padding">
         <PaymentWeeks/>
            <h1 style={{display:"flex", alignContent: "center", justifyContent:"center"}}>loading...</h1>
        </div> :
      <div className="profile-page-bottom height padding">
         <PaymentWeeks/>
