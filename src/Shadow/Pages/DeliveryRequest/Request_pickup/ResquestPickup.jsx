  ...
  return (
    <section className="user-dashboard">
      ...
      <div className="set-location-pickup">
        ...
        <h4>Where are you?</h4>
        <p>
          Tell us your location so that we can pair you with the nearest
          availabe pickup request
        </p>
        <Link to="/request-location">
          <button className="set-location-btn">Set location</button>
        </Link>
      </div>
    </section>
  );
