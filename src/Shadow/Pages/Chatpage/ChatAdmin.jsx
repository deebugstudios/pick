    ...
    <div className="chat-wrapper">
      ...
      <div className="chat-right-side">
        ...
        <div className="message-header">
          <h6>Conversations <img src={report} alt="report flag" /> </h6>
        </div>
        <div className="messages-wrapper">
          <p className='date-of-msg'>TODAY MARCH 23</p>
          <div className="incoming-msgs">
            <p>I am reporting Delivery “ID 879709” for “Parcel Seal Broken”</p>
            <p>Good afternoon Andrew, your report has been recorded and would be reviewed by the admin.</p>
            <p>hi</p>
          </div>
