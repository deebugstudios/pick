...
console.log(formData)
    ...
    const handleSubmitChangeProfile = (e) => {
        ...
        // }else{
          ...
          bodyFormData.append("profile_img", file, file.name);
    ...
    <div className="profile-page-bottom pad">
        ...
        <p style={{textAlign:"center", marginTop:"10px"}}> <span className="red-message">{error}</span> <span className="green-message">{success}</span></p>
          ...
          <br />
            ...
            <input type="file" id="profile_img" name="profile_img"  className="imageSelect" accept='image/*' onChange={onImageChange}/>
            <br />
