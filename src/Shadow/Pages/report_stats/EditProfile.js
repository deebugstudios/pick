...
console.log(formData)
    ...
    const handleSubmitChangeProfile = (e) => {
        ...
        // }else{
          ...
          bodyFormData.append("profile_img", profileImage, profileImage.name);
    ...
    <div className="profile-page-bottom pad">
        ...
        <p style={{textAlign:"center", marginTop:"10px"}}> <span className="red-message">{error}</span> <span className="green-message">{success}</span></p>
          ...
          <br />
            ...
            />
            <br />
            <label htmlFor="driver_license_expiry_date">driver_license_expiry_date</label>
            <br />
            <input
              type="date"
            ...
            <div className="driverLicenseSelect">
              ...
              <span className="driverLicenseSelect-span">{profileImage ? profileImage.name : "Upload New Profile Image"}</span>
            </div>
            </label>
            <input type="file" id="profile_img" name="profile_img"  className="imageSelect" onChange={(e)=> setProfileImage(e.target.files[0])}/>
            <br />
            <div className="profile-confirm-btns">
              <button className="cancel-btn" onClick={handleCancel}>
                Cancel
              </button>
              <button type="submit" className="save-and-update-btn" onClick={handleSubmitChangeProfile} disabled={loading}>
                 {loading ? <ClipLoader color={"black"} loading={loading}  size={15} /> : "Save and update" }      
              </button>
            </div>
          </form>
        </div>
