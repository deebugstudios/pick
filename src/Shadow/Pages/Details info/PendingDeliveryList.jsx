...
import '../Pending_deliveries/Pending_delivery_pickup/pendingdeliverypickup.css'
                ...
                <div className="pending-delivery-pickup-details-wrapper">
                    <div className="pending-delivery-pickup-detail">
                        ...
                        <div className='icon-img'>
                         <Link to="">   <img src={icons} alt='icon'/> </Link>
                        </div>
                           <Link to="/DeliveryhistoryDetails"><button className='delivery-list-btn'>View Details</button> </Link> 
                        </div>
                    </div>
                <Outlet/>
                </div>
