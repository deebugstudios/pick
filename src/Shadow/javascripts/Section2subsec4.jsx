    ...
    <section className="section2subsec4">
      <div className='background-green'>
        <div className='left-green-background'>
          <h3>Get your items Picked up and Delivered <br/> Swiftly using <span>PICKLOAD</span></h3>
        <div className='social-btn-container'>
          <button className='social-btn'><img src={googleplay} alt="" /></button>
          <button className='social-btn'><img src={appstore} alt="" /></button>
        </div>
        </div>
      ...
      <div className='wrapper-second-green'>
        <div className="second-green">
          <div className="first-bg-green">
            ...
            <div>
            <button className='social-btn second-btn-style '><img src={googleplay} alt="" /></button>
            <button className='social-btn second-btn-style '><img src={appstore} alt="" /></button>
            </div>
            
          </div>
          <div className="second-bg">
            <div className='second-bg-text'>
              <h3>Sign Up to become a Rider with <span> PICKLOAD </span></h3>
            </div>
