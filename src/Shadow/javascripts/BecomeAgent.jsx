  ...
  return (
    <section className="agent-wrapper">
      <div className="agent-left-side">
        <h3>
          Become a <span className="green-bgc">Delivery Agent</span> on PickLoad
        </h3>
        <p>
          At PickLoad, we register logistics companies and individuals on our
          platform who are ready to provide fast, reliable and secure logistics
          services to users.
        </p>
