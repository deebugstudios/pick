        ...
        <div className="contact-details-wrapper">
            ...
            <div className="contact-inputs-container">
                <form>
                    ...
                    <br />
                    <input type="text" name="fullName" id="fullName" placeholder='Enter your full name' onChange={handleChange}/>
                    <br />
                    ...
                    <div className='wrappered-input'>
                        ...
                        <input type="number" name="number" id="number"  className='contact-us-input-number'  placeholder='Enter Your Phone Number' onChange={handleChange}/>
                    </div>
                    <br />
                    <label htmlFor="message">Message</label>
                    <br />
                    <textarea name="message" id="message" placeholder='Type your message here' onChange={handleChange}></textarea>
                </form>
            </div>
